/*
 *--------------------
 *made by miller 2016/09/10 
 *dialogue javascript
 *version 1.0:design Interactive animation;
 *--------------------
 */
var userInfo = {
	pc:{avatar:'./img/pc.jpg'}
};
var data = [
	{
		pc:[{order:1,txt:"你知道吗？IPhone7发布了，新增了亮黑色，特别酷！"},{order:2,txt:"而且！IOS10更新后，iMessage简直逆天！不仅支持手画表情包还可以互动玩游戏！网友表示：iMessage这次瞄准了微信呀~"},{order:3,img:"./img/img1.png"}],
		answer:[{order:4,type:1,txt:"哦。（来自iPhone7plus256G客户端）"}]
	},
	{
		pc:[{order:2,img:"./img/img2.gif"},{order:3,txt:"2016年全年法定节假日只剩7天！就在这个国庆！你是选择出去玩“穿越人山人海”还是宅在家“坐拥西瓜与电脑”?"},{order:4,img:"./img/img3.png"}],
		user:[{order:1,type:1,txt:"哦。（来自iPhone7plus256G客户端）"}],
		answer:[{order:5,type:1,txt:"地球人太恐怖，我只想回火星…"}]
	},
	{
		pc:[{order:2,txt:"你的心愿很快就能实现了！"},{order:3,txt:"9.15日，“天宫二号”上天啦！“天宫二号”是一个空间实验室，可供航天员在其中驻留，可谓名副其实的“天宫”。"},{order:4,img:"./img/img5.gif"}],
		user:[{order:1,type:1,txt:"地球人太恐怖，我只想回火星…"}],
		answer:[{order:5,type:1,txt:"挑着中秋节去给嫦娥送月饼？"}]
	},
	{
		pc:[{order:2,txt:"哈哈哈，吃个月饼也是不容易，且吃且珍惜！"},{order:3,txt:"前不久，阿里五个员工抢月饼，把工作抢没了，全程只用了两小时，真是史上最快的一次离职！网友众说纷纭，有说作弊抢月饼可耻的，有说阿里因为这点小事就开除老员工太寒心的。"},{order:4,txt:"我反正是晕了，你觉得呢？"}],
		user:[{order:1,type:1,txt:"挑着中秋节去给嫦娥送月饼？"}],
		answer:[{order:5,type:1,txt:"阿里做得好！"},{order:5,type:2,txt:"阿里太过分了！"}]
	},
	{
		pc:[{order:2,txt:"就知道你会这么说"},{order:3,txt:"资本市场就是这样，不知道什么时候就翻脸了。╮(╯▽╰)╭"},{order:4,txt:"你看之前微信开始收费时对外宣称决不收费的支付宝，还不是开始收费了吗？你看之前一直对着烧钱，不烧垮对方不开心的滴滴和UBER，还不是合并了吗？你说合并就算了吧，价格越来越贵…都要赶上出租车了",emoticon:['./emoticon/36.gif']},{order:5,txt:"这就叫：与其互相烧钱，不如一起挣钱啊~"}],
		user:[{order:1,type:1,txt:"阿里做得好！"},{order:1,type:2,txt:"阿里太过分了！"}],
		answer:[{order:6,type:1,txt:"是啊 T T"},{order:6,type:2,txt:"不在乎这点小钱",emoticon:["./emoticon/happy.png"]}]
	},
	{
		...
		user:[{order:1,type:1,txt:"是啊 T T"},{order:1,type:2,txt:"不在乎这点小钱",emoticon:["./emoticon/happy.png"]}],
		answer:[{order:4,type:1,txt:"到处乱停的小橙车吗?"},{order:4,type:2,txt:"酷诶！"}]
	},
	{
		...
		user:[{order:1,type:1,txt:"到处乱停的小橙车吗?"},{order:1,type:2,txt:"酷诶！"}],
		answer:[{order:4,type:1,txt:"怜爱58员工30秒"},{order:4,type:2,txt:"求别说，我也是996",emoticon:['./emoticon/9.gif','./emoticon/9.gif']}]
	},
	{
		pc:[{order:2,txt:"所以说我这辈子因为穷做过最委屈的事情就是上班啊",emoticon:['./emoticon/9.gif']},{order:3,txt:"老天一次又一次把机会摆在我面前，而我却选择无视…最近有个投资品很火，连马云都被它吓到了"}],
		user:[{order:1,type:1,txt:"怜爱58员工30秒"},{order:1,type:2,txt:"求别说，我也是996",emoticon:['./emoticon/9.gif','./emoticon/9.gif']}],
		answer:[{order:4,type:1,txt:"这么狂？"},{order:4,type:2,txt:"是什么？"}]
	},
	{
		pc:[{order:2,txt:"就是比特币呀！"},{order:3,img:'./img/img7.png'},{order:4,txt:"继黄金之后，中国大妈为之倾倒的又一神器。曾创下一个月暴涨500%的逆天记录。"}],
		user:[{order:1,type:1,txt:"这么狂？"},{order:1,type:2,txt:"是什么？"}],
		answer:[{order:5,type:1,txt:"500%？！"},{order:5,type:2,txt:"诈骗的吧？"}]
	},
	{
	...
	var ele_dialogue_pc = '<div class="dialogue clearfix"><div class="d-l"><div class="avatar ui-animate ui-animate-moveL"><a href="javascript:;" class="img-box"><img class="img-circle" src="' + userInfo.pc.avatar + '" alt=""></a></div><div class="bubble ui-animate ui-animate-bounce"></div></div></div>',
		ele_dialogue_user = '<div class="dialogue clearfix"><div class="d-r"><div class="bubble ui-animate ui-animate-bounce"></div></div></div>',
	...
	function analyse() {
		if (data[data_index] && data[data_index].finish) {
			var tap_after_add = setTimeout(function () {show_full_img();show_full_ewm();},1000);
			var show_ewm = setTimeout(function () {
				// showImg();
				ele_full_img = '<div class="full-box"><div class="img-full "><img src="' + ewm_src + '" alt=""></div><div class="close"></div></div>';
			...
			var btn_content = '<footer class="ui-animate-delay ui-animate-moveT js-footer"><a class="more" href="javascript:;" >' + data[data_index].btn + '</a>';
			btn_content += '</footer>';
			var put_answer = setTimeout(function () {$('.js-container').append(btn_content);},1000);
			touch.on('.wrap','touchend','.more',function (e) {
				// showImg();
				ele_full_img = '<div class="full-box"><div class="img-full "><img src="' + ewm_src + '" alt=""></div><div class="close"></div></div>';
				scroll = $(window).scrollTop();
				w_h = $(window).height();
			...
			if (data[data_index].user) {
				...
				var put_user = setTimeout(function () {add('user',user_content);},user_order * 1000);
			}
			...
			if (data[data_index].pc) {
				data[data_index].pc.forEach(function(ele) {
					(function (e) {
						...
						user_order = ele.order;
						var put_pc = setTimeout(function () {add('pc',pc_content[data[data_index].pc.indexOf(ele)]);},user_order * 1000);
					})(ele);
				});
			}
			...
			if (data[data_index].answer) {
				data[data_index].answer.forEach(function(ele) {
					...
					if (ele) {
						...
						answer_content += ('<a class="more" href="javascript:;" data-type=' + ele.type + '>' + ele.txt + emo_content + '</a>');
						answer_order = Math.max(answer_order,ele.order);
					}
				});
				answer_content += '</footer>';
				var put_answer = setTimeout(function () {add('answer',answer_content);},answer_order * 1000);
			}	
	 	}
	 	if (data_index < (data.length - 1)) {
	 		var del = setTimeout(function () {data_index++},answer_order * 1000);
	...
	function show_full_ewm() {
		touch.on('body','tap','.d-l .img-circle',function (e) {
			// showImg();
			ele_full_img = '<div class="full-box"><div class="img-full "><img src="' + ewm_src + '" alt=""></div><div class="close"></div></div>';
			scroll = $(window).scrollTop();
			w_h = $(window).height();
	...
	touch.on('html','tap','.full-box',function (e) {
	...
	function add (sender,content) {
		...
		touch.off('body','tap','.d-l .img-circle');
		if (sender == 'pc') {
	...
	function scroll_btm() {
		...
		$('body').animate({scrollTop:container_h},1000);
	}